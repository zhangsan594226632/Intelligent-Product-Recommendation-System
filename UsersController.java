...
public class UsersController {
    ...
    @PostMapping("/login")
    @ApiImplicitParams({ @ApiImplicitParam(name = "username", value = "用户名", required = true, type = "String"), @ApiImplicitParam(name = "pwd", value = "密码", required = true, type = "String"), @ApiImplicitParam(name = "cx", value = "登录权限", required = true, type = "String") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "table", value = "表名称", required = true, type = "String"), @ApiImplicitParam(name = "col", value = "列字段名", required = true, type = "int"), @ApiImplicitParam(name = "checktype", value = "检测类型、只允许是insert、update", required = true, type = "String"), @ApiImplicitParam(name = "id", value = "当类型为update时此值必填", type = "Integer") })
    @ResponseBody
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "yuan", value = "原值", required = true, type = "String"), @ApiImplicitParam(name = "id", value = "表得行id", required = true, type = "int"), @ApiImplicitParam(name = "tablename", value = "模块名称", required = true, type = "String") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "table", value = "模块名称", required = true, type = "String"), @ApiImplicitParam(name = "id", value = "表得行id", required = true, type = "int") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "key", value = "字段名", required = true, type = "String"), @ApiImplicitParam(name = "value", value = "值", required = true, type = "String"), @ApiImplicitParam(name = "table", value = "模块名称", required = true, type = "String") })
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "where", value = "条件", required = false, type = "String"), @ApiImplicitParam(name = "table", value = "模块名称", required = true, type = "String") })
    ...
    @ResponseBody
    @ApiOperation(value = "获取某表得所有数据", httpMethod = "POST")
    @ApiImplicitParams({ @ApiImplicitParam(name = "where", value = "条件", type = "String"), @ApiImplicitParam(name = "table", value = "模块名称", required = true, type = "String") })
